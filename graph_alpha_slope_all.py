...
# 全データをプロット（エラーバー付き）
plt.errorbar(data['alpha'], data['mean_slope'], yerr=data['error'], fmt='o', color='blue', label='データ', capsize=5)
...
# グラフを保存
plt.savefig('graph_alpha_slope_all.png')
plt.close()
